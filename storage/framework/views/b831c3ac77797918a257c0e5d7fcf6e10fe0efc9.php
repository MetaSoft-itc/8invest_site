    ...
    <article class="main-layout__content"><!-- Begin page-->
                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary"><?php echo e(__("Isolated")); ?> </span> <?php echo e(__("trading pairs")); ?></h1>
                            <div class="investments-intro__description"><p><?php echo e(__("TP_info1")); ?> </p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
                        <div class="investments-intro__earn">
                            ...
                            <p class="investments-intro__earn-value">650<sub>%</sub></p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                ...
                                <p class="investments-swiper-item__value">8.9K</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$26.6M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$10.1M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$3K</p></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form>
                        <div class="calculate__block-row">
                            <div class="calculate__block-col">
                                ...
                                <p class="calculate__block-value">650%</p>
        ...
        <script>rate = 1;
            ...
            function recalc() {
                z = 1 * $('#Sum').val();
                cid = $('#PSys').val();
                $('#calc1').html(1 * ((z * 1.78 / 100).toFixed(6)));
                $('#calc2').html(1 * ((z * 54.1 / 100).toFixed(6)));
                $('#calc3').html(1 * ((z * 650 / 100).toFixed(6)));
            }
            ...
            <div class="container">
                <div class="trading-bot__row">
                    <div class="trading-bot__content"><h2 class="trading-bot__title title"><span
                                class="color-primary"><?php echo e(__("DeFi-")); ?> <?php echo e(__('staking')); ?></span> <?php echo e(__("Investment strategy")); ?></h2>
                        <div class="trading-bot__text typography"><p><?php echo __("inv_strategy1"); ?> </p>
                            <p><?php echo __("inv_strategy2"); ?></p></div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sCUM_Crypto/resources/views/pages/isolatedtradingpairs.blade.php ENDPATH**/ ?>