        ...
        <div data-v-e4d5b16a=""
            ...
            <form method="post" action="<?php echo e(route('cabinet.outcome.store')); ?>" class="grid-column-12 grid-column-6--xl grid-column-start-4--xl">
                ...
                <div data-v-e4d5b16a="" class="padding-bottom-5">
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('outcome-currency-system', [])->html();
} elseif ($_instance->childHasBeenRendered('a8IdQe1')) {
    $componentId = $_instance->getRenderedChildComponentId('a8IdQe1');
    $componentTag = $_instance->getRenderedChildComponentTagName('a8IdQe1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('a8IdQe1');
} else {
    $response = \Livewire\Livewire::mount('outcome-currency-system', []);
    $html = $response->html();
    $_instance->logRenderedChild('a8IdQe1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    ...
                    <div data-v-e4d5b16a="">
                        ...
                        <?php if(! $hasClosedDeposit): ?>
                        <p class="color-gray">
                            Вы не можете создать заявку на вывод пока у вас не будет закрытого депозита.
                        </p>
                        <?php endif; ?>
                        <button type="submit" <?php if(! $hasClosedDeposit): ?> disabled <?php endif; ?> class="width-full button button--success button--mini <?php if(! $hasClosedDeposit): ?> button--disabled <?php endif; ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/d33kei/Documents/Lar_Cry/invest/resources/views/cabinet/outcome/index.blade.php ENDPATH**/ ?>