    ...
    <article class="main-layout__content"><!-- Begin page-->
                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary"><?php echo e(__("Stacking")); ?> </span> <?php echo e(__("APY token")); ?></h1>
                            <div class="investments-intro__description"><p><?php echo e(__("APY_info1")); ?> </p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
                        <div class="investments-intro__earn">
                            ...
                            <p class="investments-intro__earn-value">286<sub>%</sub></p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                ...
                                <p class="investments-swiper-item__value">3.4K</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$24.5M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$7.5M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$7.2K</p></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form>
                        <div class="calculate__block-row">
                            <div class="calculate__block-col">
                                <div class="calculate__field field"><label class="calculate__label">Currency</label>
                                    <div class="field-payment">
                                        <div class="field-payment__icon"><img
                                                src="<?php echo e(asset('assets/images/currency/Bitcoin.svg')); ?>" alt=""></div>
                                ...
                                <p class="calculate__block-value">286%</p>
        ...
        <script>rate = 1;
            ...
            function recalc() {
                z = 1 * $('#Sum').val();
                cid = $('#PSys').val();
                $('#calc1').html(1 * ((z * 0.785 / 100).toFixed(6)));
                $('#calc2').html(1 * ((z * 23.8 / 100).toFixed(6)));
                $('#calc3').html(1 * ((z * 286 / 100).toFixed(6)));
            }
                ...
                <div class="trading-bot__row">
                    <div class="trading-bot__content">
                        <h2 class="trading-bot__title title">
                            <span class="color-primary"><?php echo e(__("Advantages of stacking")); ?> </span> <?php echo e(__("APY token")); ?></h2>
                        <div class="trading-bot__text typography">
                            <p><?php echo __("APY_info2"); ?></p>
                            <p><?php echo __("APY_info3"); ?></p></div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sCUM_Crypto/resources/views/pages/staking.blade.php ENDPATH**/ ?>