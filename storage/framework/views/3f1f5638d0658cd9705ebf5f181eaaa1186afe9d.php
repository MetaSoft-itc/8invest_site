                            ...
                            <table data-v-4cd0b858="" class="font-sm width-full">
                                ...
                                <tr data-v-4cd0b858="">
                                    ...
                                    <td data-v-4cd0b858="" class="text-right padding-y-1"> <?php echo e($deposits->where('currency', 'eur')->sum('amount') / 100000); ?>
                                        ...
                                        <span data-v-4cd0b858="" class="color-gray"> EUR </span>
                                    </td>
                ...
                <div data-v-4cd0b858="" class="border-rounded-3 padding-0-15 shadowed overflow-auto">
                    <table data-v-4cd0b858="" class="table width-full text-nowrap table--no-hover">
                        ...
                        <tr data-v-4cd0b858="" class="font-sm color-gray bg-litest-gray">
                            ...
                            <th class="padding-3 font-medium text-left"><?php echo app('translator')->get('app.Дата начала'); ?></th>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="padding-3 font-medium text-left"><?php echo e($deposit->amount / 100000); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/cabinet/deposits.blade.php ENDPATH**/ ?>