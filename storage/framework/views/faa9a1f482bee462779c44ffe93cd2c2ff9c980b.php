<script>
    ...
    const userAccounts = JSON.parse('<?php echo $accounts; ?>')
    let activeCurrency = 'BTC';

    let yearlyIncome = parseFloat('<?php echo e($percent); ?>')/100 * 364;
    let mounthlyIncome = parseFloat('<?php echo e($percent); ?>')/100 * 30;
    let daylyIncome = parseFloat('<?php echo e($percent); ?>')/100;
...
<?php /**PATH /var/www/html/sCUM_Crypto/resources/views/cabinet/new/deposits/_profitCalc.blade.php ENDPATH**/ ?>