...
<main class="flex flex-column flex-grow trans-margin-left trans-0-3">
    <div data-v-d661a07e="">
        <div data-v-d661a07e=""
             class="padding-top-6 padding-bottom-5 bg-no-repeat bg-center bg-cover bg-cluster color-white relative">
            <svg data-v-d661a07e="" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg"
                 class="hidden block--md height-8 opacity-2 absolute right-0 bottom-0 margin-bottom-5 fill-white z-index-2 margin-right-5">
                <path data-v-d661a07e="" fill="#C8CAD4"
            ...
            <div data-v-d661a07e="" class="grid box">
                <div data-v-d661a07e="" class="grid-column-12 grid-column-5--md"><h1 data-v-d661a07e=""
                                                                                     class="margin-y-0 font-normal font-4xl text-tight">
                        Вопросы и ответы</h1>
                    <p data-v-d661a07e="" class="opacity-7">Раздел, посвященный наиболее часто возникающим вопросам,
                        связанных с процессом инвестирования и взаимодействия.</p></div>
            </div>
        </div>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('f-a-q', [])->html();
} elseif ($_instance->childHasBeenRendered('Z5B1eR4')) {
    $componentId = $_instance->getRenderedChildComponentId('Z5B1eR4');
    $componentTag = $_instance->getRenderedChildComponentTagName('Z5B1eR4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z5B1eR4');
} else {
    $response = \Livewire\Livewire::mount('f-a-q', []);
    $html = $response->html();
    $_instance->logRenderedChild('Z5B1eR4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <div data-v-3971779c="" data-v-d661a07e=""
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/pages/faq.blade.php ENDPATH**/ ?>