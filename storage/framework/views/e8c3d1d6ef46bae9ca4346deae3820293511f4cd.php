<app-menu _ngcontent-c0="" _nghost-c2="">
    <nav class="user-page__side-menu  side-menu  d-2-none">
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet')); ?>"><span
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'income'): ?> _active <?php endif; ?>" href="<?php echo e(route('income')); ?>"><span
                class="side-menu__ico-wrap"><svg
            ...
            class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.deposits.new'): ?> _active <?php endif; ?>"
            href="<?php echo e(route('cabinet.deposits.new')); ?>"><span
                class="side-menu__ico-wrap"><svg
            ...
            class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.deposits'): ?> _active <?php endif; ?>"
            href="<?php echo e(route('cabinet.deposits')); ?>"><span
                class="side-menu__ico-wrap"><svg
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.account'): ?> _active <?php endif; ?>"

           href="<?php echo e(route('cabinet.account')); ?>"><span
                class="side-menu__ico-wrap"><svg
                    style="width: 24rem; height: 24rem"><use
                        xlink:href="/img/svg/sprite-user-menu.svg#ico-person"></use></svg></span><span
                class="side-menu__text">Личные данные</span></a>
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.transfer'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.transfer')); ?>"><span
                class="side-menu__ico-wrap"><svg
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.referals'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.referals')); ?>"><span
                class="side-menu__ico-wrap"><svg
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.outcome'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.outcome')); ?>"><span
                class="side-menu__ico-wrap"><svg
                    style="width: 40rem; height: 25rem"><use

                        xlink:href="/img/svg/sprite-user-menu.svg#ico-money-bill-alt"></use></svg></span><span
                class="side-menu__text">Вывод средств</span></a>
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.requisites'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.requisites')); ?>"><span
                class="side-menu__ico-wrap"><svg
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.password'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.password')); ?>"><span
                class="side-menu__ico-wrap"><svg
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.verification'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.verification')); ?>"><span
                class="side-menu__ico-wrap"><svg
        ...
        <a class="side-menu__link <?php if(Route::currentRouteName() == 'cabinet.calculator'): ?> _active <?php endif; ?>" href="<?php echo e(route('cabinet.calculator')); ?>"><span
                class="side-menu__ico-wrap"><svg
                    style="width: 24rem; height: 24rem"><use
...
<?php /**PATH /Users/maksa988/www/invest3/resources/views/cabinet/_navigation.blade.php ENDPATH**/ ?>