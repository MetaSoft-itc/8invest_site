                    ...
                    <div data-v-2eb02792="" data-v-fd87438e="">
                        ...
                        <div data-v-2eb02792="">
                            ...
                            <form method="POST" action="<?php echo e(route('cabinet.password.store')); ?>" data-v-2eb02792="" class="grid grid-row-gap-4 grid-column-gap-4--md padding-y-2">
                                <?php echo csrf_field(); ?>
                                <?php if($errors->isNotEmpty() && ! session()->has('fin_password_form')): ?>
                            ...
                            <form method="POST" action="<?php echo e(route('cabinet.fin_password.store')); ?>" data-v-2eb02792="" class="grid grid-row-gap-4 grid-column-gap-4--md padding-y-2">
                                <?php echo csrf_field(); ?>
                                <?php if($errors->isNotEmpty() && session()->has('fin_password_form')): ?>
                                    <ul class="errors grid-column-12 grid-column-6--xl grid-column-start-4--xl margin-bottom-2">
                                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/invest/resources/views/cabinet/password.blade.php ENDPATH**/ ?>