                ...
                <div class="flex--sm justify-center">
                    <div class="ribbon grid grid-row-gap-4 padding-y-4">
                        ...
                        <div class="grid-column-12">
                            <div class="field">
                                <div class="relative">
                                    ...
                                    <div class="field__input-wrapper flex items-center overflow-hidden">
                                        <input id="input_f61623m9" autocomplete="" name="invite" type="text" placeholder="Если есть, укажите код приглашения" class="field__input">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div data-v-27920d84="" class="grid-column-12">
                            <div data-v-27920d84="" class="flex">
                                <div data-v-acf68fb2="" data-v-27920d84="" tabindex="0" class="base-checkbox flex items-start no-outline no-select padding-y-2 cursor-pointer">
                                    <div data-v-acf68fb2="" class="base-checkbox__box flex justify-center items-center margin-right-2 flex-no-shrink">
                                        <!----></div>
                                    <div data-v-acf68fb2=""> Я согласен с <a data-v-27920d84="" href="/info/terms" class="margin-x-1" target="_blank" data-v-acf68fb2="">Условия и
                                            положения</a> и <a data-v-27920d84="" href="/info/privacy" class="margin-x-1" target="_blank" data-v-acf68fb2="">Политика
                        ...
                        <div class="grid-column-12 text-center">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="button button--ghost"><span
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/auth/register.blade.php ENDPATH**/ ?>