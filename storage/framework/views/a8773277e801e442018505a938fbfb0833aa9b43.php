<?php $__env->startSection('content'); ?>
    <main class="flex flex-column flex-grow trans-margin-left trans-0-3">
        <form method="POST" action="<?php echo e(route('login')); ?>" class="relative overflow-hidden margin-top-4 margin-top-0--lg">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="ribbon grid grid-row-gap-4 padding-y-4">
                            ...
                            <div class="field">
                                ...
                                <div class="relative">
                                    <div class="field__input-wrapper flex items-center overflow-hidden">
                                        <input id="input_5lv2ka3t" autocomplete="off" name="email" type="email" value="<?php echo e(old('email')); ?>" placeholder="Введите свой E-mail" class="field__input">
                                    </div>
                        ...
                        <div class="grid-column-12">
                            <div class="field field--suffix">
                                <div class="relative">
                                    <div class="field__input-wrapper flex items-center overflow-hidden">
                                        <input id="input_f61623m9" autocomplete="" name="ga_code" type="password" placeholder="Введите код Google Authenticator" class="field__input">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-column-12 text-center">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="button button--ghost"><span
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/auth/login.blade.php ENDPATH**/ ?>