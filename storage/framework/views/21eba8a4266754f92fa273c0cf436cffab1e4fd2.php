...
<?php $__env->startSection('content'); ?>
    ...
    <section id="invest-ftx">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="section__heading py-4 mb-4"><?php echo e(__("Invest in")); ?> <br><span class="c-violet">APY stacking</span></h1>
                </div>
            </div>
            <form action="<?php echo e(route('cabinet.deposits.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="text" hidden name="pack" value="apy-stacking">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12 py-4 my-4">
                        ...
                        <input type="text" value="0" class="wallet-item__info-box w-100" name="amount" >                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="amount-helper choose-helper mb-md-0 mb-4">
                            ...
                            <div class="amount-helper__item choose-helper__item">
                                ...
                                <button data-amount="10000" data-currency-eq="" class="choose-helper__btn amount-helper__btn active">$10000</button>
                            </div>
                            <div class="amount-helper__item choose-helper__item">
...
<?php echo $__env->make('layouts.cabinet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sCUM_Crypto/resources/views/cabinet/new/deposits/isolatedtradingpairs.blade.php ENDPATH**/ ?>