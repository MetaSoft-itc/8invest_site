<div class="shadowed border-rounded-3 bg-white margin-x-3 margin-top-5 margin-top-6--md margin-top-0--lg">
    <ul data-v-4aba4d7a="" class="margin-y-0 padding-x-3 no-list flex--md border-bottom-gray relative">
        <li data-v-4aba4d7a="" class="margin-bottom-2 margin-bottom-0--md margin-right-4--md">
            <button data-v-4aba4d7a="" wire:click="changeCurrency('<?php echo e(\App\Account::CURRENCY_USD); ?>')" class="tab flex items-center text-accent font-medium relative <?php if($currency == \App\Account::CURRENCY_USD): ?> router-link-exact-active router-link-active tab--active <?php endif; ?>" aria-current="page">
        ...
        <li data-v-4aba4d7a="" class="margin-bottom-2 margin-bottom-0--md margin-right-4--md">
            <button data-v-4aba4d7a="" wire:click="changeCurrency('<?php echo e(\App\Account::CURRENCY_EUR); ?>')" class="tab flex items-center text-accent font-medium relative <?php if($currency == \App\Account::CURRENCY_EUR): ?> router-link-exact-active router-link-active tab--active <?php endif; ?>" aria-current="page">
                <img src="<?php echo e(asset('img/png/euro.png')); ?>" class="height-1-25 margin-right-2 flex-no-shrink">
                EU Euro
            </button>
        </li>
        <li data-v-4aba4d7a="" class="margin-bottom-2 margin-bottom-0--md margin-right-4--md">
            <button data-v-4aba4d7a="" wire:click="changeCurrency('<?php echo e(\App\Account::CURRENCY_RUB); ?>')" class="tab flex items-center text-accent font-medium relative <?php if($currency == \App\Account::CURRENCY_RUB): ?> router-link-exact-active router-link-active tab--active <?php endif; ?>" aria-current="page">
                <img src="<?php echo e(asset('img/png/ruble.png')); ?>" class="height-1-25 margin-right-2 flex-no-shrink">
                RU Rubble
            </button>
        </li>
        <li data-v-4aba4d7a="" class="margin-bottom-2 margin-bottom-0--md margin-right-4--md">
            <button data-v-4aba4d7a="" wire:click="changeCurrency('<?php echo e(\App\Account::CURRENCY_BTC_ONE); ?>')" class="tab flex items-center text-accent font-medium relative <?php if($currency == \App\Account::CURRENCY_BTC_ONE): ?> router-link-exact-active router-link-active tab--active <?php else: ?> router-link-active hover-lighten <?php endif; ?>">
        ...
        <li data-v-4aba4d7a="" class="margin-bottom-2 margin-bottom-0--md margin-right-4--md">
            <button data-v-4aba4d7a="" wire:click="changeCurrency('<?php echo e(\App\Account::CURRENCY_BTC_TWO); ?>')" class="tab flex items-center text-accent font-medium relative <?php if($currency == \App\Account::CURRENCY_BTC_TWO): ?> router-link-exact-active router-link-active tab--active <?php else: ?> router-link-active hover-lighten <?php endif; ?>">
        ...
        <div data-v-7032d9db="" data-v-2b67d23d="" data-vv-as=" " class="field flex-grow">
            ...
            <div data-v-7032d9db="" class="relative">
                <div data-v-7032d9db=""
                    ...
                    <input data-v-7032d9db="" wire:model="days" id="input_3j2q1nek" inputmode="text" autocomplete="" type="text" placeholder="0" class="field__input">
                </div>
            </div>
        </div>
    </div>
            ...
            <li data-v-4aba4d7a="" class="grid-column-12 grid-column-6--md grid-column-4--xl">
                <div data-v-2b67d23d="" data-v-4aba4d7a="" class="border-rounded-3 shadowed padding-3">
                    ...
                    <div data-v-2b67d23d="" class="padding-bottom-2">
                        <button data-v-141d1a81="" wire:click="invest('<?php echo e($key); ?>')" data-v-2b67d23d="" <?php if($amount == 0): ?> disabled <?php endif; ?> class="width-full button button--primary <?php if($amount == 0): ?> button--disabled <?php endif; ?> button--mini">
...
<?php /**PATH /Users/maksa988/www/invest3/resources/views/livewire/create-deposit.blade.php ENDPATH**/ ?>