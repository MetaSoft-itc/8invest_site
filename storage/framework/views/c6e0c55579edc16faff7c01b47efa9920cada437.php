                ...
                <div data-v-98a0e610="" class="padding-0-15 shadowed border-rounded-3 overflow-auto fix-tooltip">
                    <table data-v-98a0e610="" class="table width-full text-nowrap table--no-hover">
                        ...
                        <tr data-v-98a0e610="" class="font-sm color-gray bg-litest-gray">
                            ...
                            <th class="padding-3 font-medium text-left"><?php echo app('translator')->get('app.Бонусы'); ?></th>
                            <th class="padding-3 font-medium text-left"><?php echo app('translator')->get('app.Ваш код приглашения'); ?></th>
                        </tr>
                        </thead>
                        ...
                        <div class="table-responsive">
                            <table class="table-2 stats-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e((count($referals[0]) * 0.3) + (count($referals[1]) * 0.15) + (count($referals[2]) * 0.1)); ?>%
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/cabinet/referals.blade.php ENDPATH**/ ?>