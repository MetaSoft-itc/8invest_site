<div data-v-0297da3b="" class="grid-column-12 grid-column-6--xl grid-column-start-4--xl padding-bottom-5">
    ...
    <p data-v-0297da3b="" class="color-gray font-sm"> Компания Teqra предоставляет возможность мгновенного
        ...
        другой валюте которую вы получите. Ежедневное ограничение по конвертации составляет 5 раз в сутки.
        За каждый обмен средств внутри аккаунта взимается оплата в размере 3%. </p>
...
<?php /**PATH /Users/maksa988/www/invest3/resources/views/livewire/conversion-form.blade.php ENDPATH**/ ?>