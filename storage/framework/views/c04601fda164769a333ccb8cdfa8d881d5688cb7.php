    ...
    <article class="main-layout__content"><!-- Begin page-->
                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary"><?php echo e(__("Landing")); ?> </span> <?php echo e(__("in the stock market")); ?></h1>
                            <div class="investments-intro__description"><p><?php echo e(__("investing_info")); ?> </p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
                        <div class="investments-intro__earn">
                            ...
                            <p class="investments-intro__earn-value">100<sub>%</sub></p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                ...
                                <p class="investments-swiper-item__value">11K</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$82.5M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$10.4M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$7.5K</p></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="growing">
            <div class="container">
                <div class="growing__row">
                    ...
                    <div class="growing__media"><img class="growing__image" src="assets/images/growing/chart.png"
                        ...
                        <div class="calculate__block-row">
                                ...
                                <div class="calculate__field field"><label class="calculate__label"><?php echo e(__("Currency")); ?></label>
                                    <div class="field-payment">
                                        ...
                                        <select class="js-select-payment" name="PSys" id="PSys">
                                            <option value="6" data-icon-src="<?php echo e(asset('assets/images/currency/Bitcoin.svg')); ?>">
                                                Bitcoin
                                            </option>
                                            <option value="7" data-icon-src="<?php echo e(asset('assets/images/currency/ETH.svg')); ?>">
                                                Ethereum
                                            </option>
                                            <option value="8" data-icon-src="<?php echo e(asset('assets/images/currency/LTC.svg')); ?>">
                                                Litecoin
                                            </option>
                                            <option value="10" data-icon-src="<?php echo e(asset('assets/images/currency/DOGE.svg')); ?>">
                                                Dogecoin
                                            </option>
                                            <option value="11"
                                            ...
                                            <option value="12" data-icon-src="<?php echo e(asset('assets/images/currency/XRP.svg')); ?>">
                                                Ripple
                                            </option>
                                            <option value="13" data-icon-src="<?php echo e(asset('assets/images/currency/TRX.svg')); ?>">
                                                TRON
                                            </option>
                                            <option value="14"
                                            ...
                                            <option value="18"
                                                    data-icon-src="<?php echo e(asset('assets/images/currency/DAI.svg')); ?>">DAI
                                                (ERC20)
                                            </option>
                                        </select></div>
                                </div>
                                <p class="calculate__block-value-label"><?php echo e(__("Average Income Per Year")); ?></p>
                                <p class="calculate__block-value">100%</p>
                            ...
                            <div class="calculate__block-col">
                                <div class="calculate__field field"><label class="calculate__label"><?php echo e(__("Deposit Total")); ?></label>
                                    <div class="calculate__field-group js-slider-field" min="50000" max="1000000"
                                         step="10"><input type="number" min="50000" max="1000000" value="520000"
                                                          name="total" id="Sum">
                                        <div class="calculate__field-group-after" id="curr"></div>
                                    </div>
                                    <div class="calculate__progress">
                                        <div class="calculate__progress-labels"><p>50000</p>
                                            <p>1,000,000</p></div>
                                    </div>
                                </div>
        ...
        <script>rate = 1;
            ...
            function recalc() {
                z = 1 * $('#Sum').val();
                cid = $('#PSys').val();
                $('#calc1').html(1 * ((z * 0.273 / 100).toFixed(6)));
                $('#calc2').html(1 * ((z * 8.22 / 100).toFixed(6)));
                $('#calc3').html(1 * ((z * 100 / 100).toFixed(6)));
            }
            ...
            <div class="container">
                <div class="trading-bot__row">
                    <div class="trading-bot__content"><h2 class="trading-bot__title title"><span
                                class="color-primary"><?php echo e(__("Crypto credit")); ?> </span> <?php echo e(__("as your income")); ?></h2>
                        <div class="trading-bot__text typography">

                            <p><?php echo __("invest1"); ?></p>
                            <p><?php echo __("invest2"); ?></p></div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sCUM_Crypto/resources/views/pages/stockmarket.blade.php ENDPATH**/ ?>