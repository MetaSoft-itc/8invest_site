...
} elseif ($_instance->childHasBeenRendered('z6f33ma')) {
    $componentId = $_instance->getRenderedChildComponentId('z6f33ma');
    $componentTag = $_instance->getRenderedChildComponentTagName('z6f33ma');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('z6f33ma');
} else {
    $response = \Livewire\Livewire::mount('income-currency-system', []);
    $html = $response->html();
    $_instance->logRenderedChild('z6f33ma', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/invest/resources/views/cabinet/income/index.blade.php ENDPATH**/ ?>