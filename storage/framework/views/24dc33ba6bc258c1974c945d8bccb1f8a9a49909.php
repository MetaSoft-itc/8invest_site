...
} elseif ($_instance->childHasBeenRendered('Bt8BvyO')) {
    $componentId = $_instance->getRenderedChildComponentId('Bt8BvyO');
    $componentTag = $_instance->getRenderedChildComponentTagName('Bt8BvyO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Bt8BvyO');
} else {
    $response = \Livewire\Livewire::mount('notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('Bt8BvyO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/d33kei/Documents/Lar_Cry/invest/resources/views/cabinet/notifications.blade.php ENDPATH**/ ?>