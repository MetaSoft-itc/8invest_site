<?php $__env->startSection('content'); ?>
    <main class="flex flex-column flex-grow trans-margin-left trans-0-3">
        <div data-v-46a33078="">
            <div data-v-46a33078=""
                 class="padding-top-6 padding-bottom-5 bg-no-repeat bg-center bg-cover bg-typing color-white relative">
                ...
                <div data-v-46a33078="" class="grid box">
                    <div data-v-46a33078="" class="grid-column-12 grid-column-5--md"><h1 data-v-46a33078=""
                                                                                         class="margin-y-0 font-normal font-4xl text-tight">
                            Пассивный доход </h1>
                        <p data-v-46a33078="" class="opacity-7"> Уникальная возможность укрепить свое финансовое
                            положение, развивая инвестиционное сотрудничество с нашей компанией. </p></div>
                </div>
            </div>
            <div data-v-46a33078="" class="padding-y-6 bg-no-repeat bg-center bg-cover bg-wave-gray">
                <div data-v-46a33078="" class="box">
                    <div data-v-46a33078="" class="grid padding-bottom-6">
                        <div data-v-46a33078="" class="grid-column-12 grid-column-8--md"><h1 data-v-46a33078=""
                                                                                             class="title"> Программа
                                пассивного дохода </h1>
                            <p data-v-46a33078="" class="font-lg"> Уровень пассивного дохода не зависит от внешних
                                условий. Вы сами формируете инвестиции, самостоятельно создавая вложения на том или ином
                                депозите. Мы выполняем функции финансового менеджмента, гарантируя сохранность
                                инвестированных денег в любой ситуации. Для этого мы создали Инвестиционную программу,
                                используя которую, каждый клиент получает возможность пассивного заработка онлайн. </p>
                        </div>
                    </div>
                </div>
            </div>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('calculator', [])->html();
} elseif ($_instance->childHasBeenRendered('PS1hFcm')) {
    $componentId = $_instance->getRenderedChildComponentId('PS1hFcm');
    $componentTag = $_instance->getRenderedChildComponentTagName('PS1hFcm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PS1hFcm');
} else {
    $response = \Livewire\Livewire::mount('calculator', []);
    $html = $response->html();
    $_instance->logRenderedChild('PS1hFcm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div data-v-3971779c="" data-v-46a33078=""
                ...
                <div data-v-3971779c="" class="grid box">
                    <div data-v-3971779c="" class="grid-column-12 grid-column-6--md padding-y-3">
                        <div data-v-3971779c="" class="color-white font-3xl text-tight relative"><span
                                data-v-3971779c="" class="relative z-index-1">Будь в числе лучших уже сейчас!<br>Начинай сотрудничество с Avax и выходи за рамки обыденного вместе с лучшей командой трейдеров уже сегодня!</span>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/d33kei/Documents/Lar_Cry/invest/resources/views/pages/passive.blade.php ENDPATH**/ ?>