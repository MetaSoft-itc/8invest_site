...
} elseif ($_instance->childHasBeenRendered('lBMUgoY')) {
    $componentId = $_instance->getRenderedChildComponentId('lBMUgoY');
    $componentTag = $_instance->getRenderedChildComponentTagName('lBMUgoY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lBMUgoY');
} else {
    $response = \Livewire\Livewire::mount('outcome-currency-system', []);
    $html = $response->html();
    $_instance->logRenderedChild('lBMUgoY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/invest/resources/views/cabinet/outcome/index.blade.php ENDPATH**/ ?>