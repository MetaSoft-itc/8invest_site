...
<?php $__env->startSection('content'); ?>
    ...
    <section id="invest-ftx">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="section__heading py-4 mb-4"><?php echo e(__("Invest in")); ?> <br><span class="c-violet">APY trading bot</span></h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 py-4 my-4">
                    ...
                    <?php endif; ?>
                    <input data-amount="0" type="text" value="0" class="wallet-item__info-box w-100" name="amountUSD" hidden id="amount-input">
...
<?php echo $__env->make('layouts.cabinet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sCUM_Crypto/resources/views/cabinet/new/deposits/ftx.blade.php ENDPATH**/ ?>