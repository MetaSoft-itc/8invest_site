...
} elseif ($_instance->childHasBeenRendered('OFvbP2w')) {
    $componentId = $_instance->getRenderedChildComponentId('OFvbP2w');
    $componentTag = $_instance->getRenderedChildComponentTagName('OFvbP2w');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OFvbP2w');
} else {
    $response = \Livewire\Livewire::mount('create-deposit', []);
    $html = $response->html();
    $_instance->logRenderedChild('OFvbP2w', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </main>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/cabinet/newDeposit.blade.php ENDPATH**/ ?>