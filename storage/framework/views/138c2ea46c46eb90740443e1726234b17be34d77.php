        ...
        <div data-v-6a617831="" class="ticker">
            <div data-v-6a617831="" class="tradingview-widget-container" style="width: 100%; height: 46px;">
                <iframe scrolling="no" allowtransparency="true" frameborder="0"
                        src="https://s.tradingview.com/embed-widget/ticker-tape/?locale=uk#%7B%22symbols%22%3A%5B%7B%22proName%22%3A%22FOREXCOM%3ASPXUSD%22%2C%22title%22%3A%22S%26P%20500%22%7D%2C%7B%22proName%22%3A%22FOREXCOM%3ANSXUSD%22%2C%22title%22%3A%22Nasdaq%20100%22%7D%2C%7B%22proName%22%3A%22FX_IDC%3AEURUSD%22%2C%22title%22%3A%22EUR%2FUSD%22%7D%2C%7B%22proName%22%3A%22BITSTAMP%3ABTCUSD%22%2C%22title%22%3A%22BTC%2FUSD%22%7D%2C%7B%22proName%22%3A%22BITSTAMP%3AETHUSD%22%2C%22title%22%3A%22ETH%2FUSD%22%7D%5D%2C%22showSymbolLogo%22%3Afalse%2C%22colorTheme%22%3A%22dark%22%2C%22isTransparent%22%3Afalse%2C%22displayMode%22%3A%22adaptive%22%2C%22width%22%3A%22100%25%22%2C%22height%22%3A74%2C%22utm_source%22%3A%22teqra.com%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22ticker-tape%22%7D"
        ...
        <div data-v-6a617831="" class="box">
            <div data-v-6a617831="" class="relative margin-top-4">
                ...
                <div data-v-6a617831="" class="flex overflow-hidden color-white border-rounded-3">
                    ...
                    <div data-v-6a617831=""
                         ...
                         style="background-image: url(&quot;/img/steps.avif&quot;); transform: translateX(0%);">
                        <div data-v-6a617831="" class="grid-column-12 grid-column-8--md padding-y-4"><h2
                            ...
                            <p data-v-6a617831=""> Для того, чтобы начать инвестировать, вы должны войти в свой
                                аккаунт, нажать на кнопку «Инвестировать» и затем, пользуясь подсказками системы,
                    ...
                    <div data-v-6a617831=""
                         class="slide flex items-center width-full grid bg-no-repeat bg-center bg-cover flex-no-shrink overflow-auto trans-transform trans-0-4 padding-x-3 padding-x-5--md padding-x-6--lg"
                         style="background-image: url(&quot;/img/cash.avif&quot;); transform: translateX(0%);">
                        <div data-v-6a617831="" class="grid-column-12 grid-column-8--md padding-y-4"><h2
                                data-v-6a617831="" class="font-normal"> Важно знать </h2>
                            <p data-v-6a617831=""> Все начисления по вкладам производятся через 24 часа с момента
                                активации вашего депозита. Таким образом, уже через сутки, после того, как вы внесли
                                депозит, вы сможете получить первые дивиденды в случае, если данное событие не
                                придется на праздничный или выходной день. </p></div>
                    </div>
                    <?php endif; ?>
                    <?php if($tip == 3): ?>
                    <div data-v-6a617831=""
                         class="slide flex items-center width-full grid bg-no-repeat bg-center bg-cover flex-no-shrink overflow-auto trans-transform trans-0-4 padding-x-3 padding-x-5--md padding-x-6--lg"
                         style="background-image: url(&quot;/img/charts.avif&quot;); transform: translateX(0%);">
                        <div data-v-6a617831="" class="grid-column-12 grid-column-8--md padding-y-4"><h2
                                data-v-6a617831="" class="font-normal"> Важно знать </h2>
                            <p data-v-6a617831=""> Все запросы на вывод средств, в том числе и запросы по
                                реферальным вознаграждениям, в целях безопасности транзакций обрабатываются вручную.
                                Это может занять до 48-ми часов. </p></div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            <div data-v-383f5412="" data-v-6a617831=""
                ...
                <a data-v-f6930a7e="" data-v-6a617831=""
                   href="<?php echo e(route('page.news.show', $item)); ?>"
                   ...
                   id="480" data-v-383f5412="">
                    <div data-v-f6930a7e=""
                        ...
                        <div data-v-f6930a7e=""
                            ...
                            <span data-v-f6930a7e=""><?php echo e($item->published_at->format('Y-m-d')); ?></span><!----></div>
                        <div data-v-f6930a7e=""
                        ...
                        <div data-v-f6930a7e="" class="news-content trans-transform trans-0-3 color-gray">
                            <?php echo e(Purify::clean(\Illuminate\Support\Str::limit($item->description, 500))); ?>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/pages/news.blade.php ENDPATH**/ ?>