<?php $__env->startSection('title', 'Безопасность'); ?>
            ...
            <div data-v-fd87438e="" class="grid">
                <div data-v-fd87438e="" class="grid-column-12 grid-column-8--xl grid-column-start-3--xl padding-y-4">
                    <div data-v-2eb02792="" data-v-fd87438e="">
                        ...
                        <div data-v-2eb02792="">
                            <div data-v-2eb02792="" class="padding-y-3">
                                <strong data-v-2eb02792="" class="text-accent">
                                    Сброс пароля
                                </strong>
                            </div>
                            <form method="POST" action="<?php echo e(route('cabinet.password.store')); ?>" data-v-2eb02792="" class="grid grid-row-gap-4 grid-column-gap-4--md padding-y-2">
                                <?php echo csrf_field(); ?>
                                ...
                                <div data-v-2eb02792="" class="grid-column-12 grid-column-6--md">
                                    <div data-v-7f923647="" data-v-2eb02792="" data-vv-as=" " class="field">
                                        ...
                                        <div data-v-7f923647="" class="relative">
                                            <div data-v-7f923647=""
                                                 class="field__input-wrapper flex items-center overflow-hidden">
                                                <!----><input data-v-7f923647="" name="password_cofirmed" id="input_k4akjwo6" autocomplete=""
                            ...
                            <form method="POST" action="<?php echo e(route('cabinet.ga.connect')); ?>" data-v-2eb02792="" class="padding-y-4">
                                <?php echo csrf_field(); ?>
                                <strong data-v-2eb02792="" class="text-accent">
                                ...
                                <ul data-v-2eb02792=""
                                    ...
                                    <li data-v-2eb02792="" class="grid-column-12"><strong data-v-2eb02792=""
                                        ...
                                        <p data-v-2eb02792="" class="margin-y-1 color-gray"> Для входа в аккаунт
                                            teqra.com используется уникальный одноразовый код. Их можно получить с
                                            ...
                                            администрацию компании Teqra. </p></li>
                                </ul>
                                <div data-v-2eb02792="" class="flex margin-y-3 border-rounded-3 overflow-hidden">
                                    <div data-v-2eb02792=""
                                         class="flex justify-center items-center width-4 padding-y-3 <?php if(auth()->user()->ga_secret): ?> bg-green <?php else: ?> bg-orange <?php endif; ?>">
                                        <svg data-v-2eb02792="" viewBox="0 0 18 22" fill="none"
                                ...
                                <div data-v-2eb02792="" class="flex margin-y-3">
                                    <img data-v-2eb02792="" src="<?php echo e($qr); ?>" alt="SHB2YO4XO54KRIDM">
                                </div>
                                <?php endif; ?>
                                <ul class="errors grid-column-12 grid-column-6--xl grid-column-start-4--xl margin-bottom-2">
                                    <?php if(session()->has('ga_error')): ?>
                                ...
                                <div data-v-2eb02792="" class="grid-column-12 grid-column-6--md mt-3">
                                    <button data-v-141d1a81="" data-v-2eb02792="" class="width-full button button--primary button--mini">
                                        <span data-v-141d1a81="" class="button__content">
                                            ...
                                            <?php if(! auth()->user()->ga_secret): ?> Активировать <?php else: ?> Деактивировать <?php endif; ?>
                                        </span>
                                    </button>
                                </div>
                            </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/cabinet/password.blade.php ENDPATH**/ ?>