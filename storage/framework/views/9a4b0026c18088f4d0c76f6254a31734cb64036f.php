...
} elseif ($_instance->childHasBeenRendered('n1s6elw')) {
    $componentId = $_instance->getRenderedChildComponentId('n1s6elw');
    $componentTag = $_instance->getRenderedChildComponentTagName('n1s6elw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('n1s6elw');
} else {
    $response = \Livewire\Livewire::mount('notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('n1s6elw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/cabinet/notifications.blade.php ENDPATH**/ ?>