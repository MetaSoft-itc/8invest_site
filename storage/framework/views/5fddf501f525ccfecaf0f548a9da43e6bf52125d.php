...
<main class="flex flex-column flex-grow trans-margin-left trans-0-3">
    <div id="shares-guest">
        <div
            ...
            <div class="grid box">
                <div class="grid-column-12"><h1
                    ...
                    <?php
                    $diff = \Carbon\Carbon::parse('2021-12-25')->diff(now());
                    ?>
                    ...
                    <div class="flex flex-column items-start justify-center">
                        <div data-v-98868d82="" class="timer_wrapper shares-actions--timer grey-6">
                            ...
                            <div data-v-98868d82="" class="descriptions-slot">
                                <div data-v-98868d82="" class="descriptions-slot__numbers">
                                    <?php $__currentLoopData = str_split(sprintf('%02d', $diff->m)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $minute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="padding-y-4 padding-y-6--md">
            <div class="grid box">
                <div class="grid-column-12 grid-column-6--lg"><h1 class="title">Что такое Teqra Message?</h1>
                    <div class="grid margin-y-4">
                        <div class="grid-column-12 grid-column-6--md">
                            <div class="flex flex-column padding-y-4--md padding-y-3 padding-right-3">
                                ...
                                <div class="margin-top-2 text-upper color-black">Синхронизация с компанией Teqra
                                </div>
                            </div>
                        </div>
                        <div class="grid-column-12 grid-column-6--md">
                            <div class="flex flex-column padding-y-4--md padding-y-3 padding-right-3">
                                ...
                                <div class="margin-top-2 text-upper color-black">Отправка и получение средств не
                                    выходя из заявки
                                </div>
                            </div>
                        </div>
                        <div class="grid-column-12 grid-column-6--md">
                            <div class="flex flex-column padding-y-4--md padding-y-3 padding-right-3">
                                ...
                                <div class="margin-top-2 text-upper color-black">Платежная система всегда у вас в
                                    телефоне
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-column-12 grid-column-6--md">
                            <div class="flex flex-column padding-y-4--md padding-y-3 padding-right-3">
                                ...
                                <div class="margin-top-2 text-upper color-black">Интеграция контактов с возможностью
                                    использования функции простого мессенджера, без привязки к сайту teqra.com
                                </div>
                            </div>
                        </div>
                        <div class="grid-column-12 grid-column-6--md">
                        ...
                        <div class="grid-column-12 grid-column-6--md">
                            <div class="flex flex-column padding-y-4--md padding-y-3 padding-right-3">
                                ...
                                <div class="margin-top-2 text-upper color-black">Удобство и простота использования
                                </div>
                            </div>
                        </div>
                    </div>
                    <a href="https://play.google.com/store/apps/details?id=com.teqra.message.app" target="_blank"
                       class="flex"><img src="/img/public_img_google-play_en.png" height="40"
                                         alt="Google Play download"></a></div>
                <div class="grid-column-12 grid-column-6--lg"><img src="/img/messenger-preview.png"
        ...
        <div class="shares-guest__why bg-cover bg-center padding-y-4 padding-y-6--md">
            <div class="grid box">
                <div class="grid-column-12 grid-column-6--lg flex">
                    <div class="shares-guest__why--video"><img src="/img/messenger-video.png" class="width-full">
                        <div class="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
                            <div class="color-white flex flex-column items-center justify-center cursor-pointer">
                                ...
                                <div class="text-accent font-medium no-select">Проиграть видео</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="grid-column-12 grid-column-6--lg padding-x-4 flex flex-column justify-center"><h1
                        class="title">Почему Teqra Message</h1>
                    <p>Уникальность нашего приложения в том, что к нашему бизнесу ежедневно подключается огромное
                        ...
                        новый уровень и выпускаем собственный продукт под брендом Teqra. У вас есть уникальная
                        возможность инвестировать в него и получать еще больше прибыли, сотрудничая с нами. Движение
                        к цели вместе с нашей сплоченной командой Teqra принесет вам гарантированный успех.</p>
                    <div class="flex"><a data-v-141d1a81="" href="/account/shares" class="button button--primary">
                            <!----><span data-v-141d1a81=""
                                         class="button__content"> ИНВЕСТИРОВАТЬ В TEQRA MESSAGE</span></a></div>
                </div>
            </div>
        </div>
        <div class="padding-y-4 padding-y-6--md relative">
            <div class="font-normal margin-y-0 font-4xl--md text-center">История Teqra Message</div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="shares-guest__roadmap--subtitle">Февраль</div>
                    <div class="shares-guest__roadmap--description">Тест успешно пройден</div>
                </div>
                <div
                    class="shares-guest__roadmap--item flex flex-column justify-start items-center padding-3--lg padding-y-5 padding-x-2">
                    <svg width="25" height="26" fill="none" xmlns="http://www.w3.org/2000/svg" class="">
                    ...
                    <div class="shares-guest__roadmap--description">Успешный запуск бета-версии на платформе Teqra
                    </div>
                </div>
                <div
                    class="shares-guest__roadmap--item flex flex-column justify-start items-center padding-3--lg padding-y-5 padding-x-2">
                    ...
                    <div class="shares-guest__roadmap--title">2021</div>
                    <div class="shares-guest__roadmap--subtitle">Октябрь</div>
        ...
        <div
            ...
            <div class="color-white font-2xl text-center padding-x-3">Подумайте о будущем и своих перспективах.
                Покупая акции Teqra Message сейчас, вы инвестируете в свое ближайшее будущее. Teqra гарантирует вам
                успех и процветание, работая вместе с нашей сплоченной командой!
            </div>
            <a data-v-141d1a81="" href="/account/shares" class="margin-top-3 button button--lite"><!----><span
        ...
        <div class="padding-y-4 padding-y-6--md relative">
            ...
            <div class="grid box">
                <div class="grid-column-12 grid-column-6--lg z-index-2"><h1 class="title">Teqra Message в
                        цифрах</h1>
                    <p>В учетной записи пользователя вы можете покупать акции Teqra со своего личного баланса. Акции
                    ...
                    <div class="grid">
                        <div class="grid-column-12 grid-column-6--lg padding-y-3 padding-right-2">
                            <div class="shares-guest__chart--title color-primary"><?php echo e(\App\TrackingItem::query()->latest('datetime')->whereNull('user_id')->where('datetime', '<', now())->first(['value'])->value); ?> USD</div>
                            <div class="shares-guest__chart--subtitle">ЦЕНА СЕЙЧАС</div>
                        </div>
                        <div class="grid-column-12 grid-column-6--lg padding-y-3 padding-right-2">
                            <div class="shares-guest__chart--title color-green">347 USD</div>
                            <div class="shares-guest__chart--subtitle">ОЖИДАЕМАЯ ЦЕНА ЗА 6 МЕСЯЦЕВ</div>
                        </div>
                        <div class="grid-column-12 grid-column-6--lg padding-y-3 padding-right-2">
                            <div class="shares-guest__chart--title">10855</div>
                    ...
                    <div class="flex margin-y-4"><a data-v-141d1a81="" href="/account/shares"
                                                    class="button button--primary"><!----><span data-v-141d1a81=""
                                                                                                class="button__content">ИНВЕСТИРОВАТЬ В TEQRA MESSAGE</span></a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maksa988/www/invest3/resources/views/pages/tm.blade.php ENDPATH**/ ?>