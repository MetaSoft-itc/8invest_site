...
} elseif ($_instance->childHasBeenRendered('vuZ9tPE')) {
    $componentId = $_instance->getRenderedChildComponentId('vuZ9tPE');
    $componentTag = $_instance->getRenderedChildComponentTagName('vuZ9tPE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vuZ9tPE');
} else {
    $response = \Livewire\Livewire::mount('transfer-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('vuZ9tPE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/invest/resources/views/cabinet/transfer.blade.php ENDPATH**/ ?>