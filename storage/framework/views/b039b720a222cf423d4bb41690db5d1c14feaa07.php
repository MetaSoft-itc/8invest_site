    ...
    <article class="main-layout__content"><!-- Begin page-->
                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary"><?php echo e(__("Investing")); ?> </span> <?php echo e(__("in IDO")); ?></h1>
                            <div class="investments-intro__description"><p><?php echo e(__("IDO_info")); ?> </p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                ...
                                <p class="investments-swiper-item__value">3.5K</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                        ...
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                ...
                                <p class="investments-swiper-item__value">$14.2M</p></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="investments-swiper-item">
                                <div class="investments-swiper-item__icon">
                                ...
                                <p class="investments-swiper-item__value">$2.5K</p></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>rate = 1;
            ...
            function recalc() {
                z = 1 * $('#Sum').val();
                cid = $('#PSys').val();
                $('#calc1').html(1 * ((z * 0.824 / 100).toFixed(6)));
                $('#calc2').html(1 * ((z * 25 / 100).toFixed(6)));
                $('#calc3').html(1 * ((z * 300 / 100).toFixed(6)));
            }
            ...
            <div class="container">
                <div class="trading-bot__row">
                    <div class="trading-bot__content"><h2 class="trading-bot__title title"><span
                                class="color-primary"><?php echo e(__("Why is it important")); ?> </span> <?php echo e(__("and what is IDO")); ?></h2>
                        <div class="trading-bot__text typography">
                            <p><?php echo __("IDO1"); ?></p>
                            <p><?php echo __("IDO2"); ?></p></div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sCUM_Crypto/resources/views/pages/investIDO.blade.php ENDPATH**/ ?>