            ...
            <div data-v-5851cc65="" class="grid-column-12">
                ...
                <ul data-v-5851cc65=""
                    ...
                    <li data-v-5851cc65="" class="grid-column-12 grid-column-2--md relative padding-y-3 padding-left-3--md">
                        <div data-v-5851cc65="" class="hidden block--md vertical-divider absolute right-0 top-0 bottom-0 margin-y-auto"></div>
                        <div data-v-5851cc65="" class="flex items-center text-accent font-medium" style="color: rgb(13, 129, 59);">
                            <img src="<?php echo e(asset('img/a.png')); ?>" class="height-1 margin-right-2">
                            AM
                        </div>
                        <div data-v-5851cc65="" class="flex items-center font-xl--lg" style="word-break: keep-all; white-space: nowrap;">
                            ...
                            <a data-v-5851cc65="" href="<?php echo e(route('income')); ?>?currency=AM" class="flex border-rounded-3 bg-lite-green padding-x-3 padding-y-2 hover-darken">
                                <svg data-v-5851cc65="" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="height-0-5"><path data-v-5851cc65="" d="M5 0a1 1 0 00-1 1v3H1a1 1 0 100 2h3v3a1 1 0 102 0V6h3a1 1 0 100-2H6V1a1 1 0 00-1-1z" fill="#569A21"></path></svg>
                            </a>
                        </div>
                    </li>
                    ...
                    <li data-v-5851cc65="" class="grid-column-12 grid-column-2--md relative padding-y-3">
                        ...
                        <div data-v-5851cc65="" class="flex items-center font-xl--lg" style="word-break: keep-all; white-space: nowrap;">
                            <?php echo e($accounts->where('currency', \App\Account::CURRENCY_BTC_ONE)->first()->extended_amount); ?>
                    ...
                    <li data-v-5851cc65="" class="grid-column-12 grid-column-2--md relative padding-y-3"><!---->
                        ...
                        <div data-v-5851cc65="" class="flex items-center font-xl--lg" style="word-break: keep-all; white-space: nowrap;">
                            <?php echo e($accounts->where('currency', \App\Account::CURRENCY_BTC_TWO)->first()->extended_amount); ?>
                ...
                <div data-v-5851cc65=""
                    ...
                    <div data-v-5851cc65="" class="flex--sm items-center padding-3 flex-grow">
                        <div data-v-5851cc65=""
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset($user->avatar_url)); ?>" style="width: 67px; height: 67px;" class="height-full border-round fill-white">
                            <?php endif; ?>
                        </div>
                        <div data-v-5851cc65="" class="min-width-none flex flex-column items-start margin-left-3--sm margin-top-3 margin-top-0--sm">
                            ...
                            <div data-v-5851cc65="" class="flex items-center font-sm max-width-full btn-copy" data-clipboard-text="<?php echo e(route('register', ['code' => $user->code])); ?>">
                    ...
                    <div data-v-5851cc65="" class="padding-3 overflow-auto">
                        <table data-v-5851cc65="" class="font-sm width-full">
                            ...
                            <tr data-v-5851cc65="">
                                <td data-v-5851cc65="" class="padding-y-1">
                                    <div data-v-5851cc65="" class="flex items-center font-medium">
                                        <img src="<?php echo e(asset('img/a.png')); ?>" class="height-1 fill-default margin-right-2">
                                        AM
                                    </div>
                                </td>
                                <td data-v-5851cc65="" class="text-right padding-y-1">
                                    <?php echo e($referalsBalances[\App\Account::CURRENCY_EUR]); ?><span data-v-5851cc65="" class="color-gray"> AM </span>
                                </td>
                            </tr>
                            <tr data-v-5851cc65="">
                                <td data-v-5851cc65="" class="padding-y-1">
                        ...
                        <table data-v-5851cc65="" class="font-sm width-full">
                            ...
                            <tr data-v-5851cc65="">
                                ...
                                <td data-v-5851cc65="" class="text-right font-medium color-green padding-y-1">
                                    <?php echo e(number_format($accounts->where('currency', \App\Account::CURRENCY_USD)->first()->deposits_sum_balance, 2, '.', ' ')); ?> USD
                                </td>
                            </tr>
                            <tr data-v-5851cc65="">
                                <td data-v-5851cc65="" class="padding-y-1">
                                ...
                                <td data-v-5851cc65="" class="text-right font-medium color-green padding-y-1">
                                    <?php echo e(number_format($accounts->where('currency', \App\Account::CURRENCY_EUR)->first()->deposits_sum_balance, 2, '.', ' ')); ?> AM
                                </td>
                            </tr>
                            <tr data-v-5851cc65="">
                                <td data-v-5851cc65="" class="padding-y-1">
                                ...
                                <td data-v-5851cc65="" class="text-right font-medium color-green padding-y-1">
                                    <?php echo e(number_format($accounts->where('currency', \App\Account::CURRENCY_RUB)->first()->deposits_sum_balance, 2, '.', ' ')); ?> RUB
                                </td>
                            </tr>
                            <tr data-v-5851cc65="">
                                <td data-v-5851cc65="" class="padding-y-1">
                                ...
                                <td data-v-5851cc65="" class="text-right font-medium color-green padding-y-1">
                                    <?php echo e(number_format($accounts->where('currency', \App\Account::CURRENCY_BTC_ONE)->first()->deposits_sum_balance, 4, '.', ' ')); ?> <?php echo e(config('crypto.'. \App\Account::CURRENCY_BTC_ONE .'.name')); ?>
                            ...
                            <tr data-v-5851cc65="">
                                ...
                                <td data-v-5851cc65="" class="text-right font-medium color-green padding-y-1">
                                    <?php echo e(number_format($accounts->where('currency', \App\Account::CURRENCY_BTC_TWO)->first()->deposits_sum_balance, 4, '.', ' ')); ?> <?php echo e(config('crypto.'. \App\Account::CURRENCY_BTC_TWO .'.name')); ?>
                    ...
                    <div class="bill__block  _main">
                        ...
                        <table class="bill__table">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($accounts->where('currency', \App\Account::CURRENCY_BTC_ONE)->first()->extended_amount); ?></td>
                            </tr>
                            <tr>
                                <td><?php echo e(config('crypto.'. \App\Account::CURRENCY_BTC_TWO .'.name')); ?>:</td>
                                <td><?php echo e($accounts->where('currency', \App\Account::CURRENCY_BTC_TWO)->first()->extended_amount); ?></td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <section class="user-section _col-3 _full-content bill fadeInUp"
                    ...
                    <div class="bill__block  _main">
                        ...
                        <table class="bill__table">
                            ...
                            <tr>
                                <td><?php echo e(config('crypto.'. \App\Account::CURRENCY_BTC_ONE .'.name')); ?>:</td>
                                <td><?php echo e($accounts->where('currency', \App\Account::CURRENCY_BTC_ONE)->first()->extended_deposits); ?>&nbsp;</td>
                            </tr>
                            <tr>
                                <td><?php echo e(config('crypto.'. \App\Account::CURRENCY_BTC_TWO .'.name')); ?>:</td>
                                <td><?php echo e($accounts->where('currency', \App\Account::CURRENCY_BTC_TWO)->first()->extended_deposits); ?>&nbsp;</td>
                            </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/d33kei/Documents/Lar_Cry/invest/resources/views/cabinet/index.blade.php ENDPATH**/ ?>