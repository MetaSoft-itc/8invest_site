...
@section('content')
    <article class="main-layout__content"><!-- Begin page-->
                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary">{{__("Landing")}} </span> {{__("in the stock market")}}</h1>
                            <div class="investments-intro__description"><p>{{__("investing_info")}} </p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
        ...
        <section class="calculate">
            <div class="container"><h2 class="calculate__title title"><span class="color-primary">{{__("Calculate")}}</span>
                    {{__("Your Income")}}</h2>
            ...
            <div class="container">
                <div class="trading-bot__row">
                    <div class="trading-bot__content"><h2 class="trading-bot__title title"><span
                                class="color-primary">{{__("Crypto credit")}} </span> {{__("as your income")}}</h2>
