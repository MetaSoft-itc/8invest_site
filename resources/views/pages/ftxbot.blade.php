                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary">{{__("APY trading")}}</span> {{__("BOT")}}</h1>
                            <div class="investments-intro__description"><p>{{__("B55_bot_info")}}</p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
            ...
            <div class="container">
                <div class="trading-bot__row">
                    <div class="trading-bot__content"><h2 class="trading-bot__title title"><span
                                class="color-primary">{{__("Why do we")}} </span> {{__("even need trading robots?")}}</h2>
                        <div class="trading-bot__text typography"><p>{{__("bot_info_1")}}</p>
                            <p>{!! __("bot_info_2") !!}</p>
                            <p>{{__("This is just a small part of what B55 trading algorithms are capable of.")}}</p></div>
                    ...
                    <div class="trading-bot__media"><img class="trading-bot__image"
                                                         src="{{asset('assets/images/trading-bot/image.png')}}" alt=""
