                ...
                <div class="investments-intro__row">
                    <div class="investments-intro__col">
                        <div class="investments-intro__content"><h1 class="investments-intro__title title"><span
                                    class="color-primary">{{__("Isolated")}} </span> {{__("trading pairs")}}</h1>
                            <div class="investments-intro__description"><p>{{__("TP_info1")}} </p></div>
                        </div>
                    </div>
                    <div class="investments-intro__col">
            ...
            <div class="container">
                <div class="trading-bot__row">
                    <div class="trading-bot__content"><h2 class="trading-bot__title title"><span
                                class="color-primary">{{__("DeFi-")}} {{__('staking')}}</span> {{__("Investment strategy")}}</h2>
                        <div class="trading-bot__text typography"><p>{!! __("inv_strategy1") !!} </p>
                            <p>{!! __("inv_strategy2") !!}</p></div>
