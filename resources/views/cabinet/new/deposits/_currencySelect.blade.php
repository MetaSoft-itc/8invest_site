<div class="calculate__field field">
    <div class="field-payment">
        <div class="field-payment__icon">
            <img src="assets/images/currency/Bitcoin.svg" alt="">
        </div>
        <select class="js-select-payment" name="currency" id="PSys">
            ...
            <option value="USD"
                    data-icon-src="{{asset('assets/images/currency/USD.svg')}}">USD
            </option>
            <option value="USDC"
            ...
            {{--                                <option value="17"
                                                    data-icon-src="assets/images/currency/USDC.svg">USDC
                                                (ERC20)
                                            </option>--}}
            {{--<option value="DAI"
            ...
            <option value="DASH"
                    data-icon-src="{{asset('assets/images/currency/DASH.svg')}}">DASH
            </option>
            <option value="ATOM"
                    data-icon-src="{{asset('assets/images/currency/ATOM.svg')}}">ATOM
            </option>
            <option value="APY"
                    data-icon-src="{{asset('assets/images/currency/APY.svg')}}">APY
            </option>
            <option value="BCH"
                    data-icon-src="{{asset('assets/images/currency/BCH.svg')}}">BCH
            </option>
            <option value="DOT"
                    data-icon-src="{{asset('assets/images/currency/DOT.svg')}}">Polkadot ( BEP-20 )
            </option>
            <option value="TON"
                    data-icon-src="{{asset('assets/images/currency/TON.svg')}}">TON (BEP-20)
            </option>
            <option value="UMEE"
                    data-icon-src="{{asset('assets/images/currency/UMEE.png')}}">UMEE
            </option>
            <option value="BLD"
                    data-icon-src="{{asset('assets/images/currency/BLD.png')}}">Agoric
            </option>
            <option value="RUB"
                    data-icon-src="{{asset('assets/images/currency/RUB.svg')}}">RUB
            </option>
        </select>
    </div>
</div>
