<div class="mobile-menu">
    ...
    <div class="mobile-menu__inner">
        ...
        @endauth
        <div class="profile-navigation"><a class="profile-navigation__user" href="{{route('cabinet')}}"><span
                    class="profile-navigation__avatar"> <img src="{{asset('assets/images/profile/ava.png')}}" alt="Avatar"></span>
                <span class="profile-navigation__username">{{auth()->user()->name}} </span>
            </a>
