    ...
    <div class="mobile-menu__inner">
        @guest
            <div class="mobile-menu__top">
                <a class="btn btn--calypso btn--size-small mobile-menu__btn" href="{{route('login')}}">
                    <span>{{__("Log in")}}</span></a>
                <a class="btn btn--calypso btn--line-black btn--size-small mobile-menu__btn"
                   href="{{route('register')}}"> <span>{{__("Sign Up")}}</span></a>
            </div>
        @endguest
            @auth
                <div class="mobile-menu__top">
            ...
            @endauth
        <div class="profile-navigation"><a class="profile-navigation__user" href="{{route('cabinet')}}">
                <span class="profile-navigation__avatar"> <img src="{{asset('assets/images/profile/ava.png')}}" alt=""></span>
                <span class="profile-navigation__username">@auth {{auth()->user()->name}} @endauth </span>
            </a>
            <ul class="profile-navigation__list">
                <li><a href="{{route('cabinet')}}">
                                <span class="svg-icon">
                                    @include('cabinet.new.icons.user-ico')
                                </span>
                        <span>{{__("Account")}}</span></a></li>
                <li><a href="{{route('cabinet.deposits')}}">
                                <span class="svg-icon">
                                    @include('cabinet.new.icons.deposit-ico')
                                </span>
                        <span>{{__("My deposits")}}</span></a></li>
                <li><a href="{{route('cabinet.referals')}}">
                                <span class="svg-icon">
